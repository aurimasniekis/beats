...
|<<metricbeat-module-intel_power_gadget,intel_power_gadget>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-intel_power_gadget-cpu,cpu>> beta[]  
...
include::modules/intel_power_gadget.asciidoc[]
